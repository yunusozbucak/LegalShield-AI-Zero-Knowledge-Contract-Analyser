 ...
 * Refactored to use STRICT REGEX LITERALS (/pattern/g).
 * This eliminates the "new RegExp" string parsing errors that cause White Screen crashes in production.
 */
...
export const maskPII = (text: string): { maskedText: string; piiMap: Map<string, string> } => {
  ...
  // Expanded Regex Literal for Entity Detection - HARDCODED for safety
